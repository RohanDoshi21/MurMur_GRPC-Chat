...
var MessageWhere = struct {
	...
	IsGroup:   whereHelpernull_Bool{field: "\"messages\".\"is_group\""},
}
...
var (
	messageAllColumns            = []string{"id", "sender", "receiver", "content", "timestamp", "is_group"}
	messageColumnsWithoutDefault = []string{"sender", "receiver", "content"}
	messageColumnsWithDefault    = []string{"id", "timestamp", "is_group"}

...
type Group struct {
	...
	Users     types.StringArray `boil:"users" json:"users" toml:"users" yaml:"users"`
...
var GroupWhere = struct {
	...
	Users     whereHelpertypes_StringArray
	...
	Users:     whereHelpertypes_StringArray{field: "\"groups\".\"users\""},
	Owner:     whereHelperstring{field: "\"groups\".\"owner\""},
...
func (r *groupR) GetInvites() InviteSlice {
	if r == nil {
		return nil
	}
	return r.Invites
...
var (
	groupAllColumns            = []string{"id", "name", "users", "owner", "created_at", "updated_at"}
	groupColumnsWithoutDefault = []string{"id", "name", "users", "owner"}
